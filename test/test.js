...
function testGetClient() {
  ...
  assert.equal(api.telerivet.requests[0][0], "http://oaf.com/Clients/7890/KE");
  assert.equal(api.telerivet.requests[0][1].headers.accountpin, "111");
  assert.equal(api.telerivet.requests[0][1].headers.apikey, "12345");
  ...
  assert.equal(api.telerivet.requests[0][0], "http://oaf.com/Clients/5555/UG");
  assert.equal(api.telerivet.requests[0][1].headers.accountpin, "222");
  assert.equal(api.telerivet.requests[0][1].headers.apikey, "12345");
}
